...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    if (!token || !user || (user.privilege !== 'Manager Dashboard' && user.privilege !== 'System Admin')) {
      // If unauthorized, set notification and schedule redirect
      setNotification("You do not have access to the Dashboard. Redirecting to login...");
